  ...
  <div class="shop-header">
    ...
    <div class="shop-content">
      ...
      <div class="header-content">
        <h2 class="content-title" @click="toggelShopShow">
    ...
    <!--初始数据时不显示，这里不能使用v-show，因为初始状态v-show也是会渲染，只是隐藏起来-->
    <div class="shop-header-discounts" v-if="info.supports">
      <div class="discounts-left">
        <!--三级表达式会报错，原因是初始值为空时，二级表达式是undefined，三级表达式只能报错-->
      ...
      <div class="discounts-right" @click="toggelSupportShow">
    ...
    <transition name="fade">
      <div class="activity-sheet"v-show="supportShow" >
        <div class="activity-sheet-content">
          ...
          <div class="activity-sheet-close" @click="toggelSupportShow">
